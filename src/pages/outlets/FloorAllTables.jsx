  ...
  const columns = [
    {
      ...
      label: "Table",
      render: (row) => (
        <span className="font-semibold text-slate-800">{row.table_number}</span>
      ),
    },

    {
      ...
      label: "Section",
      render: (row) => (
        <span className="text-slate-600">{row.section_name}</span>
      ),
    },

    {
      key: "capacity",
      label: "Capacity",
      render: (row) => <span className="text-slate-700">{row.capacity}</span>,
    },

    {
      ...
      label: "Shape",
      render: (row) => (
        <span className="capitalize text-slate-600">{row.shape}</span>
      ),
    },

    {
      ...
      label: "Guests",
      render: (row) => (
        <span className="text-slate-700">{row.guest_count ?? 0}</span>
      ),
    },
